 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Request::administrator();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::rider();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::customer();
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function readonlyApiResources($resources, $options = [])
        {
                        \Illuminate\Routing\Router::readonlyApiResources($resources, $options);
        }
...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\Route::as($value);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\PendingResourceRegistration::readonly();
        }
